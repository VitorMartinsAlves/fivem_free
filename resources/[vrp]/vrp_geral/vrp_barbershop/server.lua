...
vRPbs = {}
Tunnel.bindInterface("vrp_geral",vRPbs)
Proxy.addInterface("vrp_geral",vRPbs)
BSclient = Tunnel.getInterface("vrp_geral")

local cfg = module("vrp_geral","vrp_barbershop/cfg/barbershop")
